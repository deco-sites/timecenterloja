...
import { loader as seoPlpV2Loader, Props as SeoPlpV2Props, } from 'apps/commerce/sections/Seo/SeoPLPV2.tsx';
...
export function loader(props: Props, req: Request, ctx: AppContext) {
    ...
    const seo_by_url = props.seo_by_url_list?.find(({ url }) => new URLPattern({ pathname: url }).test(req.url));
...
export function LoadingFallback(props: Partial<SectionProps<typeof loader>>) {
    return (<SeoBaseCustomV2 {...{ ...props, has_url_query_string: !!props.has_url_query_string }}/>);
}
export default function Section(props: SectionProps<typeof loader>): SEOSection {
