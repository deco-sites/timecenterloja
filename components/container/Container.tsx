...
export type OverFlow = "overflow-none" | "overflow-auto" | "overflow-hidden" | "overflow-scroll" | "overflow-visible";
...
function Container({ sections }: Props) {
    return (<>
      {sections?.map(({ section: { Component, props }, withContainer = false, backgroundColor = "", verticalSpacing = "both", shadow = "none", overFlow = "overflow-none", spacing = 0, }) => (<div class={`w-full
