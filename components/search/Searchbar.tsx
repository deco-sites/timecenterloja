  ...
  const Searchbar = (
    <div class="flex items-center gap-4">
      <form
        id="searchbar"
        action={action}
        class="flex-grow flex gap-3 rounded-full placeholder-base-200 px-4 py-2 border-2 border-[#E2E3E8]"
      >
        <input
          ref={searchInputRef}
          id="search-input"
          class="flex w-full outline-none  placeholder:font-normal placeholder:text-[#585858] pl-2 text-sm placeholder:text-sm"
          name={name}
          defaultValue={query}
          onInput={(e) => {
