...
function ProductInfo({ page, shipmentPolitics, shareableNetworks, }: {
    ...
    const { price, listPrice, seller, installment, pixPercentDiscountByDiferenceSellerPrice, has_discount, priceWithPixDiscount, availability, } = useOffer(offers);
...
function Details({ page, variant, shipmentPolitics, shareableNetworks, highlights, discount, }: {
    page: ProductDetailsPage;
    variant: Variant;
    shipmentPolitics?: Props["shipmentPolitics"];
    shareableNetworks?: Props["shareableNetworks"];
...
function ProductDetails({ page, variant: maybeVar = "auto", shipmentPolitics, shareableNetworks, notFoundSection: { Component: ProductNotFound, props: notFoundProps }, highlights, discount, }: Props) {
    if (!page)
    ...
    return (<div id={id} class="py-0 lg:pb-10">
      <>
        <Details page={page} variant={variant} shipmentPolitics={shipmentPolitics} shareableNetworks={shareableNetworks} highlights={highlights} discount={discount}/>
