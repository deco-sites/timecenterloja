  ...
  if (isCartEmpty) {
    return (
      <div class="flex flex-col justify-center items-center h-full gap-6">
        <Icon class="text-accent" id="ShoppingCart" width={30} height={30} />
        <span class="uppercase font-medium text-sm text-secondary lg:text-base">
  ...
  return (
    <>
      ...
      <footer class="flex flex-col items-center justify-center max-lg:px-5 px-10">
        ...
        <div class="p-4 max-lg:hidden lg:flex lg:justify-between lg:mx-10 lg:px-0 w-full gap-2 xl:gap-5 lg:flex-row xl:flex-row">
          {!showClearButton && (
            <Button
              data-deco="buy-button"
              class="h-9 btn-outline lg:h-10 whitespace-nowrap px-6 uppercase hover:bg-primary hover:text-info hover:border-primary border-primary text-primary font-bold text-sm"
              disabled={loading.value || cart.value.items.length === 0}
              onClick={() => {
